...
> **当前版本**：v0.3.0（§10 字段识别 LLM 语义提取混合管线 · 落地路径 1-2 步交付 · 2026-06-08）
> **文档版本**：PRD r12（r11 + §10 旗舰方向落地路径 1-2 步交付为 V0.3.0；§9 加 V0.3.0 迭代条目 · 2026-06-08）
...
### 6.1 IndexedDB 表（Dexie schema v5）

```
projects          (id, name, createdAt, updatedAt, description, tags, applicationCount)
...
eventContexts     (id, name, theme, organizer, location, url, deadline, extraNotes, pageMetaJson, createdAt)
qaRecords         (id, projectId, eventContextId, status, qaPairs, markdownPath, submittedAt, pageUrl, pageTitle, stats, createdAt)
